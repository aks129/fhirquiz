      ...
      <CardContent className="space-y-4">
          ...
          <Alert className="border-orange-200 bg-orange-50 dark:bg-orange-950">
            ...
            <AlertDescription>
              <div className="space-y-2">
                <p className="font-semibold text-orange-800 dark:text-orange-200">⚠️ PHI Safety Warning</p>
                <p className="text-sm text-orange-700 dark:text-orange-300">
                  <strong>Never upload real patient data to public FHIR servers.</strong> Use only synthetic data 
                  generated by tools like Synthea for training purposes.
                </p>
                <p className="text-xs text-orange-600 dark:text-orange-400">
                  💡 <strong>Recommendation:</strong> For real patient data, use the Local HAPI option above or your organization's private FHIR server.
                </p>
              </div>
            </AlertDescription>
          </Alert>
        ...
        {activeServer.isLocal && (
          <Alert className="border-green-200 bg-green-50 dark:bg-green-950">
            ...
            <AlertDescription>
              <p className="font-semibold text-green-800 dark:text-green-200">🛡️ Local FHIR Active</p>
              <p className="text-sm text-green-700 dark:text-green-300">
                Your data stays on your local machine. Safe for both synthetic and real patient data (with proper authorization).
              </p>
            </AlertDescription>
          </Alert>
        )}
